                ...
                children: [
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      bool isCorrect = quizData.answers?.any((args) => args.source == quizData.question) ?? false;

                      if (!(quizData.isHidden ?? false) && !quizProvider.isAnswersUnblurred) {
                      ...
                      return Padding(
                        ...
                        child: ListTile(
                          ...
                          trailing: quizProvider.correctAnswer == quizData.answers?[index].answer
                              ? IconButton(
                            onPressed: () => _speak(quizData.answers?[index].answer ?? ""),
                            icon: Icon(
                          ...
                          tileColor: quizProvider.selectedAnswer != null
                              ? (quizProvider.correctAnswer == quizData.answers?[index].answer
                              ? AppColors.success.withValues(alpha: 0.7)
                              : (quizProvider.selectedAnswer == quizData.answers?[index].answer
                          ...
                          shape: RoundedRectangleBorder(
                            ...
                            side: BorderSide(
                              color: quizProvider.selectedAnswer == quizData.answers?[index].answer
                          ...
                          onTap: quizProvider.isAnswerLocked
                              ? null
                              : () {
                            String correctAnswer = quizData.answers?.firstWhere((entry) => entry.source == quizData.question).source ?? "";

                            quizProvider.setSelectedAnswer(quizData.answers?[index].answer ?? "", isCorrect, correctAnswer);
